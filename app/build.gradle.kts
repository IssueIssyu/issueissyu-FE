...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "API_BASE_URL", "\"${localProperties.buildConfigString("API_BASE_URL", "api.base.url", "https://spring.issueissyu.cloud/")}\"")
        buildConfigField("String", "AI_API_BASE_URL", "\"${localProperties.buildConfigString("AI_API_BASE_URL", "ai.api.base.url", "https://fastapi.issueissyu.cloud/")}\"")
